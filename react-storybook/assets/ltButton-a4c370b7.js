import{j as a}from"./jsx-runtime-8406ef1e.js";import{B as k}from"./Button-4d423377.js";import{d as S}from"./styled-components.browser.esm-9c5c32f2.js";import{t as B}from"./config-43c6afbd.js";const j=S(k)`
  border-radius: 10px;
  ...
  &&& {
    &:focus-visible {
      outline: 2px solid ${B.colors.primary};
      outline-offset: 2px;
    }
  }
  ...
  /* Border styling */
  ${e=>{if(e.$border){if(e.$borderStyles){const{width:s="1px",type:n="solid",color:r="rgb(209, 213, 219)",radius:t="24px"}=e.$borderStyles;return`
          &&& {
            border-radius: ${t};
            border: ${s} ${n} ${r};
          }
