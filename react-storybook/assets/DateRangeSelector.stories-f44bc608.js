import{j as t}from"./jsx-runtime-8406ef1e.js";import{r as p}from"./index-ad58220e.js";import{C as sa}from"./calendarOutline-2f070bee.js";import{T as Ue}from"./tickIcon-5d45ebc5.js";import{C as Je}from"./closeIcon-fe6dfcab.js";import{I as v}from"./Icon-7990d6af.js";import{S as ra}from"./stringConstants-7a556fc0.js";import{a as Ut}from"./appConstants-0f4a1d00.js";import{m as R,d as o,l as O}from"./styled-components.browser.esm-675ea4f2.js";import{b as en}from"./index-4fee7e45.js";import"./_commonjsHelpers-de833af9.js";import"./extends-4c19d496.js";import"./inheritsLoose-5494d9cc.js";import"./invoke-834bb7a1.js";import"./getElementType-727593ce.js";import"./factories-499f84ec.js";import"./clsx.m-64db5d3b.js";import"./childrenUtils-decbf9e9.js";import"./get-9dca3307.js";const oa=R`
  from {
    opacity: 0;
...
`,{DATE_RANGE_SELECTOR:{QUICK_OPTIONS:_,DAYS_OF_WEEK:N},DATE_RANGE_SELECTOR:m}=ra,{DATE_RANGE_QUICK_OPTIONS:l}=Ut,Tn=(e,i)=>{const c=new Date(e);return c.setMonth(c.getMonth()+i),c},q=e=>e.toLocaleDateString("en-US",{month:"short",day:"numeric",year:"numeric"}),yn=e=>{try{let i=e;return e.split(":").length===2&&(i=`${e}:00`),new Date(`2000-01-01T${i}`).toLocaleTimeString("en-US",{hour:"numeric",minute:"2-digit",hour12:!0})}catch{return e}},he=(e,i)=>e.getFullYear()===i.getFullYear()&&e.getMonth()===i.getMonth()&&e.getDate()===i.getDate(),wn=(e,i,c)=>{const y=new Date(e.getFullYear(),e.getMonth(),e.getDate()),w=new Date(i.getFullYear(),i.getMonth(),i.getDate()),Y=new Date(c.getFullYear(),c.getMonth(),c.getDate());return y>=w&&y<=Y},W=()=>{const e=new Date,i=e.getHours().toString().padStart(2,"0"),c=e.getMinutes().toString().padStart(2,"0");return`${i}:${c}`},Sn=(e,i)=>{const[c,y]=i.split(":").map(Number),w=new Date(e);return w.setHours(c,y,0,0),w},Ht=({value:e,onChange:i,includeTime:c=!1,disabled:y=!1,error:w=!1,popoverTitle:Y,minDate:I,customStyles:Kt={}})=>{const[D,S]=p.useState(!1),[ue,ge]=p.useState(!1),[f,j]=p.useState(new Date),[$,C]=p.useState(new Date),[Ge,zt]=p.useState(null),[Re,Ye]=p.useState(!1),[T,Ie]=p.useState(new Date),[Gt,Ft]=p.useState(""),Ne=p.useRef(null),be=p.useRef(null),We=p.useRef(null),[s,Zt]=p.useState(window.innerWidth<768),fe=[{value:l.TODAY,label:_.TODAY},{value:l.YESTERDAY,label:_.YESTERDAY},{value:l.LAST_7_DAYS,label:_.LAST_7_DAYS},{value:l.LAST_14_DAYS,label:_.LAST_14_DAYS},{value:l.LAST_30_DAYS,label:_.LAST_30_DAYS},{value:l.THIS_WEEK,label:_.THIS_WEEK},{value:l.LAST_WEEK,label:_.LAST_WEEK},{value:l.THIS_MONTH,label:_.THIS_MONTH},{value:l.LAST_MONTH,label:_.LAST_MONTH}];s&&fe.push({value:l.CUSTOM,label:m.CUSTOM_RANGE});const[xe,E]=p.useState("00:00"),[De,A]=p.useState(W()),[k,ve]=p.useState(typeof e=="string"&&Object.values(l).includes(e)?e:null);p.useEffect(()=>{typeof e=="string"&&Object.values(l).includes(e)?ve(e):ve(null)},[e]),p.useEffect(()=>{const n=()=>{Zt(window.innerWidth<768)};return window.addEventListener("resize",n),()=>window.removeEventListener("resize",n)},[]),p.useEffect(()=>{if(!e||e===l.TODAY){const n=new Date;j(n),C(n),c&&(E("00:00"),A(W()))}else if(typeof e=="string"&&e.startsWith("custom_")){const n=e.split("_");n.length>=3&&(j(new Date(n[1])),C(new Date(n[2])),c&&n.length>=5?(E(n[3]),A(n[4])):c&&(E("00:00"),A(W())))}else if(typeof e=="number"){const n=new Date(e);j(n),C(n),c&&(E("00:00"),A(W()))}else if(typeof e=="object"&&e!==null&&"startEpoch"in e)j(new Date(e.startDate)),C(new Date(e.endDate)),c&&e.startTime&&e.endTime?(E(e.startTime),A(e.endTime)):c&&(E("00:00"),A(W()));else if(typeof e=="string"){const n=new Date;let a=new Date(n),r=new Date(n);switch(e){case l.YESTERDAY:a.setDate(n.getDate()-1),r.setDate(n.getDate()-1);break;case l.LAST_7_DAYS:a.setDate(n.getDate()-6);break;case l.LAST_14_DAYS:a.setDate(n.getDate()-13);break;case l.LAST_30_DAYS:a.setDate(n.getDate()-29);break;case l.THIS_WEEK:{const u=n.getDay();a.setDate(n.getDate()-u),r.setDate(a.getDate()+6);break}case l.LAST_WEEK:{const u=n.getDay();a.setDate(n.getDate()-u-7),r.setDate(a.getDate()+6);break}case l.THIS_MONTH:{a=new Date(n.getFullYear(),n.getMonth(),1),r=new Date(n.getFullYear(),n.getMonth()+1,0);break}case l.LAST_MONTH:{a=new Date(n.getFullYear(),n.getMonth()-1,1),r=new Date(n.getFullYear(),n.getMonth(),0);break}}j(a),C(r),c&&(E("00:00"),A(W()))}Ie(new Date(f))},[e,c]),p.useEffect(()=>{Bt()},[f,$]),p.useEffect(()=>{const n=a=>{D&&be.current&&!be.current.contains(a.target)&&Ne.current&&!Ne.current.contains(a.target)&&S(!1),ue&&We.current&&!We.current.contains(a.target)&&!a.composedPath().some(r=>r instanceof HTMLElement&&r.className&&r.className.toString().includes("quickOptionsToggle"))&&ge(!1)};return document.addEventListener("mousedown",n),()=>document.removeEventListener("mousedown",n)},[D,ue]);const Bt=()=>{const n=q(f),a=q($);let r="";if(he(f,$)?r=n:r=`${n} - ${a}`,c){const u=yn(xe),h=yn(De);he(f,$)?r+=` (${u} - ${h})`:r+=` (${u} to ${h})`}Ft(r)},Le=n=>I?n<new Date(I.getFullYear(),I.getMonth(),I.getDate()):!1,Xt=n=>{Le(n)||(Re?(n<f?(C(f),j(n)):C(n),Ye(!1)):(j(n),C(n),Ye(!0)))},Jt=n=>{Re&&!Le(n)&&zt(n)},Te=()=>{Ie(n=>{const a=new Date(n);return a.setMonth(a.getMonth()-1),I&&a<new Date(I.getFullYear(),I.getMonth(),1)?n:a})},ye=()=>{Ie(n=>{const a=new Date(n);return a.setMonth(a.getMonth()+1),a})},Fe=(n,a,r,u)=>{let h,b;if(c&&r&&u){const x=Sn(n,r),M=Sn(a,u);h=x.getTime(),b=M.getTime()}else{const x=new Date(n);x.setHours(0,0,0,0);const M=new Date(a);M.setHours(23,59,59,999),h=x.getTime(),b=M.getTime()}return{startEpoch:h,endEpoch:b,startDate:n.toISOString(),endDate:a.toISOString(),startTime:r,endTime:u}},Ze=()=>{const n=Fe(f,$,c?xe:null,c?De:null);i(n),S(!1)},qe=n=>{if(n===l.CUSTOM){ge(!1),Ye(!1),S(!0),ve(null);return}const a=new Date;let r=new Date(a),u=new Date(a);switch(n){case l.TODAY:break;case l.YESTERDAY:r.setDate(a.getDate()-1),u.setDate(a.getDate()-1);break;case l.LAST_7_DAYS:r.setDate(a.getDate()-6);break;case l.LAST_14_DAYS:r.setDate(a.getDate()-13);break;case l.LAST_30_DAYS:r.setDate(a.getDate()-29);break;case l.THIS_WEEK:{const x=a.getDay();r.setDate(a.getDate()-x),u.setDate(r.getDate()+6);break}case l.LAST_WEEK:{const x=a.getDay();r.setDate(a.getDate()-x-7),u.setDate(r.getDate()+6);break}case l.THIS_MONTH:{r=new Date(a.getFullYear(),a.getMonth(),1),u=new Date(a.getFullYear(),a.getMonth()+1,0);break}case l.LAST_MONTH:{r=new Date(a.getFullYear(),a.getMonth()-1,1),u=new Date(a.getFullYear(),a.getMonth(),0);break}}j(r),C(u);const h=c?"00:00":null,b=c?W():null;if(c&&(E(h),A(b)),ge(!1),ve(n),s){const x=Fe(r,u,h,b);i(x)}},ea=()=>{s?(ge(!ue),S(!1)):(S(!D),ge(!1))},na=n=>{const a=n.getFullYear(),r=n.getMonth(),h=new Date(a,r,1).getDay(),x=new Date(a,r+1,0).getDate(),M=h,Se=[];if(M>0){const Xe=new Date(a,r,0).getDate();for(let Pe=Xe-M+1;Pe<=Xe;Pe++)Se.push(new Date(a,r-1,Pe))}const pe=[];for(let V=1;V<=x;V++)pe.push(new Date(a,r,V));const Be=[],aa=42-Se.length-pe.length;for(let V=1;V<=aa;V++)Be.push(new Date(a,r+1,V));return[...Se,...pe,...Be]},ta=(n,a=!0)=>{const r=he(n,f),u=he(n,$),h=r||u,b=Le(n),x=wn(n,f,$)&&!h,M=!!(Re&&Ge&&!h&&!b&&wn(n,f,Ge)&&n>f),pe=he(n,new Date);return t.jsx(ya,{$isCurrentMonth:a,$isSelected:h,$isStart:r,$isEnd:u,$isInRange:x,$isInHoverRange:M,$isToday:pe,$isMobile:s,$isDisabled:b,onClick:()=>Xt(n),onMouseEnter:()=>Jt(n),children:n.getDate()},n.toISOString())},L=n=>{const a=n.toLocaleString("default",{month:"long"}),r=n.getFullYear(),u=na(n),h=[N.SUNDAY,N.MONDAY,N.TUESDAY,N.WEDNESDAY,N.THURSDAY,N.FRIDAY,N.SATURDAY];return t.jsxs(fa,{children:[!s&&t.jsx("div",{children:t.jsxs(xa,{children:[a," ",r]})}),t.jsx(Da,{children:h.map(b=>t.jsx(va,{children:b},b))}),t.jsx(Ta,{children:u.map(b=>ta(b,b.getMonth()===n.getMonth()))})]})},we=(n,a)=>{a?E(n):A(n)};return p.useEffect(()=>(s&&D?document.body.style.overflow="hidden":document.body.style.overflow="",()=>{document.body.style.overflow=""}),[s,D]),t.jsxs(pa,{children:[t.jsxs(ze,{$isMobile:s,$isOpen:D,$hasError:w,$isDisabled:y,$customStyles:Kt,onClick:y?void 0:ea,ref:Ne,children:[t.jsx(ha,{$isMobile:s,children:t.jsx(sa,{width:"20px"})}),t.jsx(ma,{$isMobile:s,children:Gt}),t.jsx(ba,{$isOpen:D,children:t.jsx(v,{name:"chevron down",className:"range-selector-icon"})})]}),s&&ue&&t.jsx(wa,{$isMobile:s,$isOpen:ue,ref:We,children:t.jsx(He,{children:fe.map(n=>t.jsxs(Qe,{$isActive:k===n.value,$isCustom:n.value===l.CUSTOM,$isMobile:s,onClick:()=>qe(n.value),children:[t.jsxs(Ke,{$isMobile:s,children:[k===n.value&&t.jsx(Ue,{fill:"#3b82f6"}),n.value===l.CUSTOM&&k!==n.value&&t.jsx(v,{name:"calendar outline",className:"range-selector-icon"})]}),n.label]},n.value))})}),s&&D&&en.createPortal(t.jsx(Sa,{}),document.body),s&&D&&en.createPortal(t.jsx(nn,{$isMobile:s,$isOpen:D,ref:be,children:t.jsxs(tn,{$isMobile:s,children:[t.jsxs(an,{$isMobile:s,children:[t.jsx(sn,{$isMobile:s,children:Y||m.SELECT_DATE_RANGE}),t.jsx(rn,{$isMobile:s,onClick:()=>S(!1),children:t.jsx(Je,{style:{width:"10px",height:"10px"},strokeColor:"#6b7280"})})]}),t.jsxs("div",{children:[t.jsxs(on,{children:[t.jsxs(ln,{children:[t.jsxs(mn,{$isMobile:s,children:[t.jsxs(_e,{children:[t.jsx(Oe,{$isMobile:s,children:m.START_DATE}),t.jsx(je,{$isMobile:s,children:q(f)})]}),t.jsx(bn,{children:"-"}),t.jsxs(_e,{children:[t.jsx(Oe,{$isMobile:s,children:m.END_DATE}),t.jsx(je,{$isMobile:s,children:q($)})]})]}),s?t.jsxs(fn,{children:[t.jsxs(xn,{children:[t.jsx(Ve,{onClick:Te,children:t.jsx(v,{name:"chevron left",className:"range-selector-icon"})}),t.jsxs(Dn,{children:[T.toLocaleString("default",{month:"long"})," ",T.getFullYear()]}),t.jsx(Ve,{onClick:ye,children:t.jsx(v,{name:"chevron right",className:"range-selector-icon"})})]}),t.jsx(vn,{children:L(T)})]}):t.jsxs(cn,{children:[t.jsx($e,{$position:"left",children:t.jsx(Ce,{onClick:Te,children:t.jsx(v,{name:"chevron left",className:"range-selector-icon"})})}),L(T),L(Tn(T,1)),t.jsx($e,{$position:"right",children:t.jsx(Ce,{onClick:ye,children:t.jsx(v,{name:"chevron right",className:"range-selector-icon"})})})]}),c&&t.jsx(gn,{$isMobile:s,children:t.jsxs(pn,{$isMobile:s,children:[t.jsxs(Ae,{$isMobile:s,children:[t.jsx(ke,{children:m.START_TIME}),t.jsx(Me,{type:"time",$isMobile:s,value:xe,onChange:n=>we(n.target.value,!0)})]}),t.jsx(hn,{$isMobile:s,children:m.TO}),t.jsxs(Ae,{$isMobile:s,children:[t.jsx(ke,{children:m.END_TIME}),t.jsx(Me,{type:"time",$isMobile:s,value:De,onChange:n=>we(n.target.value,!1)})]})]})})]}),!s&&t.jsx(dn,{children:t.jsx(He,{children:fe.map(n=>t.jsxs(Qe,{$isActive:k===n.value,$isCustom:n.value===l.CUSTOM,$isMobile:!1,onClick:()=>qe(n.value),children:[t.jsxs(Ke,{$isMobile:!1,children:[k===n.value&&t.jsx(Ue,{fill:"#3b82f6"}),n.value===l.CUSTOM&&k!==n.value&&t.jsx(v,{name:"calendar outline",className:"range-selector-icon"})]}),n.label]},n.value))})})]}),t.jsxs(un,{$isMobile:s,children:[t.jsx(Ee,{$variant:"cancel",$isMobile:s,onClick:()=>S(!1),children:m.CANCEL}),t.jsx(Ee,{$variant:"apply",$isMobile:s,onClick:Ze,children:m.APPLY})]})]})]})}),document.body),!s&&D&&t.jsx(nn,{$isMobile:s,$isOpen:D,ref:be,children:t.jsxs(tn,{$isMobile:s,children:[t.jsxs(an,{$isMobile:s,children:[t.jsx(sn,{$isMobile:s,children:Y||m.SELECT_DATE_RANGE}),t.jsx(rn,{$isMobile:s,onClick:()=>S(!1),children:t.jsx(Je,{style:{width:"10px",height:"10px"},strokeColor:"#6b7280"})})]}),t.jsxs("div",{children:[t.jsxs(on,{children:[t.jsxs(ln,{children:[t.jsxs(mn,{$isMobile:s,children:[t.jsxs(_e,{children:[t.jsx(Oe,{$isMobile:s,children:m.START_DATE}),t.jsx(je,{$isMobile:s,children:q(f)})]}),t.jsx(bn,{children:"-"}),t.jsxs(_e,{children:[t.jsx(Oe,{$isMobile:s,children:m.END_DATE}),t.jsx(je,{$isMobile:s,children:q($)})]})]}),s?t.jsxs(fn,{children:[t.jsxs(xn,{children:[t.jsx(Ve,{onClick:Te,children:t.jsx(v,{name:"chevron left",className:"range-selector-icon"})}),t.jsxs(Dn,{children:[T.toLocaleString("default",{month:"long"})," ",T.getFullYear()]}),t.jsx(Ve,{onClick:ye,children:t.jsx(v,{name:"chevron right",className:"range-selector-icon"})})]}),t.jsx(vn,{children:L(T)})]}):t.jsxs(cn,{children:[t.jsx($e,{$position:"left",children:t.jsx(Ce,{onClick:Te,children:t.jsx(v,{name:"chevron left",className:"range-selector-icon"})})}),L(T),L(Tn(T,1)),t.jsx($e,{$position:"right",children:t.jsx(Ce,{onClick:ye,children:t.jsx(v,{name:"chevron right",className:"range-selector-icon"})})})]}),c&&t.jsx(gn,{$isMobile:s,children:t.jsxs(pn,{$isMobile:s,children:[t.jsxs(Ae,{$isMobile:s,children:[t.jsx(ke,{children:m.START_TIME}),t.jsx(Me,{type:"time",$isMobile:s,value:xe,onChange:n=>we(n.target.value,!0)})]}),t.jsx(hn,{$isMobile:s,children:m.TO}),t.jsxs(Ae,{$isMobile:s,children:[t.jsx(ke,{children:m.END_TIME}),t.jsx(Me,{type:"time",$isMobile:s,value:De,onChange:n=>we(n.target.value,!1)})]})]})})]}),!s&&t.jsx(dn,{children:t.jsx(He,{children:fe.map(n=>t.jsxs(Qe,{$isActive:k===n.value,$isCustom:n.value===l.CUSTOM,$isMobile:!1,onClick:()=>qe(n.value),children:[t.jsxs(Ke,{$isMobile:!1,children:[k===n.value&&t.jsx(Ue,{fill:"#3b82f6"}),n.value===l.CUSTOM&&k!==n.value&&t.jsx(v,{name:"calendar outline",className:"range-selector-icon"})]}),n.label]},n.value))})})]}),t.jsxs(un,{$isMobile:s,children:[t.jsx(Ee,{$variant:"cancel",$isMobile:s,onClick:()=>S(!1),children:m.CANCEL}),t.jsx(Ee,{$variant:"apply",$isMobile:s,onClick:Ze,children:m.APPLY})]})]})]})})]})},Qt=Ht;Ht.__docgenInfo={description:"",methods:[],displayName:"DateRangeSelector",props:{value:{required:!1,tsType:{name:"union",raw:`string | number | {
  startEpoch: number;
  endEpoch: number;
  startDate: string;
  endDate: string;
...
}`,...(Gn=(zn=G.parameters)==null?void 0:zn.docs)==null?void 0:Gn.source}}};var Fn,Zn,Bn;F.parameters={...F.parameters,docs:{...(Fn=F.parameters)==null?void 0:Fn.docs,source:{originalSource:`args => {
  const [value, setValue] = useState(args.value || DATE_RANGE_QUICK_OPTIONS.TODAY);
  const handleChange = (newValue: {
    startEpoch: number;
    endEpoch: number;
...
}`,...(Bn=(Zn=F.parameters)==null?void 0:Zn.docs)==null?void 0:Bn.source}}};var Xn,Jn,et;Z.parameters={...Z.parameters,docs:{...(Xn=Z.parameters)==null?void 0:Xn.docs,source:{originalSource:`args => {
  const [value, setValue] = useState(args.value || DATE_RANGE_QUICK_OPTIONS.TODAY);
  const handleChange = (newValue: {
    startEpoch: number;
    endEpoch: number;
...
}`,...(et=(Jn=Z.parameters)==null?void 0:Jn.docs)==null?void 0:et.source}}};var nt,tt,at;B.parameters={...B.parameters,docs:{...(nt=B.parameters)==null?void 0:nt.docs,source:{originalSource:`args => {
  const [value, setValue] = useState(args.value || DATE_RANGE_QUICK_OPTIONS.TODAY);
  const handleChange = (newValue: {
    startEpoch: number;
    endEpoch: number;
...
}`,...(at=(tt=B.parameters)==null?void 0:tt.docs)==null?void 0:at.source}}};var st,rt,ot;X.parameters={...X.parameters,docs:{...(st=X.parameters)==null?void 0:st.docs,source:{originalSource:`args => {
  const [value, setValue] = useState(args.value || DATE_RANGE_QUICK_OPTIONS.TODAY);
  const handleChange = (newValue: {
    startEpoch: number;
    endEpoch: number;
