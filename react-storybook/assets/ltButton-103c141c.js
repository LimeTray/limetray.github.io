import{j as t}from"./jsx-runtime-8406ef1e.js";import{r as z}from"./index-ad58220e.js";import{B as N}from"./Button-4d423377.js";import{d as u,l as O}from"./styled-components.browser.esm-9c5c32f2.js";import{t as A}from"./config-1dd99552.js";import{M as Y}from"./index-ea508ff6.js";import{L as K}from"./index-c869fee8.js";const h=e=>(e==null?void 0:e.radius)||"24px",U=(e,r)=>{if(!e)return"border: none;";if(r){const{width:n="1px",type:o="solid",color:a="rgb(209, 213, 219)"}=r;return`border: ${n} ${o} ${a};`}return"border: 1px solid rgb(209, 213, 219);"},j={mini:"32px",tiny:"36px",small:"40px",medium:"44px",large:"48px",big:"52px",huge:"56px",massive:"60px"},k={mini:"mini",tiny:"tiny",small:"small",medium:"small",large:"medium",big:"medium",huge:"large",massive:"large"},b=(e="small")=>j[e]||j.small,F=(e="small")=>k[e]||k.small,J=e=>{if(!e)return;const r=e.trim().split(/\s+/);return r.length===1?`${r[0]} 0`:r.length===2?`${r[0]} 0`:r.length===3?`${r[0]} 0 ${r[2]}`:`${r[0]} 0 ${r[2]} 0`},R=()=>O`
