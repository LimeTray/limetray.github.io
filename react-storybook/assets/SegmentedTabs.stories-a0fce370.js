import{j as n}from"./jsx-runtime-8406ef1e.js";import{r as c,R as _}from"./index-ad58220e.js";import{d as O,o as ke}from"./styled-components.browser.esm-675ea4f2.js";import{t as We}from"./config-43c6afbd.js";import{L as Le}from"./ltButton-5601b3c5.js";import{L as g}from"./index-5a69d6f1.js";import{u as Me}from"./ThemeContext-71b3bf8d.js";import"./_commonjsHelpers-de833af9.js";import"./Button-21321eef.js";import"./extends-4c19d496.js";import"./inheritsLoose-5494d9cc.js";import"./factories-df82d7d3.js";import"./getElementType-ff0d42f5.js";import"./childrenUtils-dd3b0ba5.js";import"./Icon-370c2d23.js";import"./Label-d5345000.js";import"./ModernAutoControlledComponent-6bbe7d3d.js";import"./assertThisInitialized-081f9914.js";import"./htmlPropsUtils-2b22d933.js";import"./includes-192f9362.js";import"./Portal-8d2f321a.js";import"./index-4fee7e45.js";import"./Ref-51c42093.js";import"./objectWithoutPropertiesLoose-f3b3ace0.js";import"./map-20538cdf.js";const Re=O.div`
  position: relative;
  display: flex;
  flex-direction: row;
...
`,qe=O.div`
  ...
  pointer-events: none;
  z-index: 0;
`,y=(e,t,r,o)=>e?o||(t?r.colors.darkModeText:r.colors.white):t?r.colors.darkModeText:r.colors.text,x=(e,t,r,o,i)=>e?o||(t?r.colors.darkModeText:r.colors.white):i||(t?r.colors.darkModeText:r.colors.text),be=(e,t,r,o)=>e?"transparent":o||(t?r.colors.darkModeBgSecondary:r.colors.backgroundSecondary),De=O.div`
  position: relative;
  z-index: 1;
...
`,h=({options:e,selectedId:t,onSelectionChange:r,size:o="medium",fullWidth:i=!1,disabled:u=!1,className:ve,iconOnly:Te=!1,selectedBgColor:k,selectedTextColor:q,hoverBgColor:D,hoverTextColor:F,containerBgColor:Ie,containerBorderColor:ze,containerBorderWidth:Ce,gap:V})=>{const b=Me().theme==="dark",W=c.useRef(null),L=c.useRef([]),[M,$e]=c.useState({left:0,width:0}),Be=Te||e.every(s=>!s.label&&(s.leftElement||s.rightElement)),R=()=>{const s=e.findIndex(f=>f.id===t);if(s===-1)return;const l=L.current[s],a=W.current;if(!l||!a)return;const p=l.getBoundingClientRect(),S=a.getBoundingClientRect();$e({left:p.left-S.left,width:p.width})};c.useEffect(()=>{R()},[t,e,i,V]),c.useEffect(()=>{const s=W.current;if(!s)return;const l=new ResizeObserver(()=>{R()});l.observe(s);let a;const p=()=>{clearTimeout(a),a=setTimeout(()=>{R()},150)};return window.addEventListener("resize",p),()=>{l.disconnect(),window.removeEventListener("resize",p),clearTimeout(a)}},[t,e]);const Ee=s=>s==="medium"?"large":s,we=s=>_.isValidElement(s)&&s.props&&s.props.icon?s.props.icon:null,G=s=>{var l;u||s.disabled||(r==null||r(s.id),(l=s.onClick)==null||l.call(s))};return n.jsx(ke,{theme:We,children:n.jsxs(Re,{ref:W,fullWidth:i,className:ve,darkMode:b,containerBgColor:Ie,containerBorderColor:ze,containerBorderWidth:Ce,gap:V,children:[n.jsx(qe,{darkMode:b,selectedBgColor:k,style:{left:`${M.left}px`,width:`${M.width}px`,opacity:M.width===0?0:1}}),e.map((s,l)=>{const a=t===s.id,p=l===0,S=l===e.length-1;if(Be){const f=s.leftElement||s.rightElement,je=we(f);return n.jsx(Fe,{ref:Oe=>L.current[l]=Oe,isFirst:p,isLast:S,isSelected:a,darkMode:b,selectedBgColor:k,selectedTextColor:q,hoverBgColor:D,hoverTextColor:F,onClick:()=>G(s),children:_.isValidElement(f)?f:n.jsx(g,{icon:je,size:Ee(o),disabled:u||s.disabled,fitted:!0})},s.id)}else return n.jsx(De,{ref:f=>L.current[l]=f,isFirst:p,isLast:S,isSelected:a,darkMode:b,selectedBgColor:k,selectedTextColor:q,hoverBgColor:D,hoverTextColor:F,children:n.jsx(Le,{label:s.label,leftElement:s.leftElement,rightElement:s.rightElement,size:o,disabled:u||s.disabled,onClick:()=>G(s),transparent:!0,border:!1})},s.id)})]})})};h.__docgenInfo={description:"",methods:[],displayName:"SegmentedTabs",props:{options:{required:!0,tsType:{name:"Array",elements:[{name:"TabOption"}],raw:"TabOption[]"},description:""},selectedId:{required:!1,tsType:{name:"string"},description:""},onSelectionChange:{required:!1,tsType:{name:"signature",type:"function",raw:"(selectedId: string) => void",signature:{arguments:[{type:{name:"string"},name:"selectedId"}],return:{name:"void"}}},description:""},size:{required:!1,tsType:{name:"SemanticSIZES"},description:"",defaultValue:{value:"'medium'",computed:!1}},fullWidth:{required:!1,tsType:{name:"boolean"},description:"",defaultValue:{value:"false",computed:!1}},disabled:{required:!1,tsType:{name:"boolean"},description:"",defaultValue:{value:"false",computed:!1}},className:{required:!1,tsType:{name:"string"},description:""},iconOnly:{required:!1,tsType:{name:"boolean"},description:"",defaultValue:{value:"false",computed:!1}},selectedBgColor:{required:!1,tsType:{name:"string"},description:""},selectedTextColor:{required:!1,tsType:{name:"string"},description:""},hoverBgColor:{required:!1,tsType:{name:"string"},description:""},hoverTextColor:{required:!1,tsType:{name:"string"},description:""},containerBgColor:{required:!1,tsType:{name:"string"},description:""},containerBorderColor:{required:!1,tsType:{name:"string"},description:""},containerBorderWidth:{required:!1,tsType:{name:"string"},description:""},gap:{required:!1,tsType:{name:"string"},description:""}}};const pt={title:"SegmentedTabs",component:h,parameters:{layout:"centered"},argTypes:{size:{control:{type:"select"},options:["mini","tiny","small","medium","large","big","huge","massive"]},fullWidth:{control:{type:"boolean"}},disabled:{control:{type:"boolean"}},iconOnly:{control:{type:"boolean"}},selectedBgColor:{control:{type:"color"}},selectedTextColor:{control:{type:"color"}},hoverBgColor:{control:{type:"color"}},hoverTextColor:{control:{type:"color"}},containerBgColor:{control:{type:"color"}},containerBorderColor:{control:{type:"color"}},containerBorderWidth:{control:{type:"text"}},gap:{control:{type:"text"},description:'Gap between tabs (e.g., "4px", "8px", "1rem")'}}},d=[{id:"layout",label:"Layout"},{id:"styling",label:"Styling"},{id:"content",label:"Content"}],Ve=[{id:"layout",label:"Layout",leftElement:n.jsx(g,{icon:"th",size:"small"})},{id:"styling",label:"Styling",leftElement:n.jsx(g,{icon:"paint brush",size:"small"})},{id:"content",label:"Content",leftElement:n.jsx(g,{icon:"file text",size:"small"})}],Se=[{id:"mobile",leftElement:n.jsx(g,{icon:"mobile",size:"small"})},{id:"tablet",leftElement:n.jsx(g,{icon:"tablet",size:"small"})},{id:"computer",leftElement:n.jsx(g,{icon:"computer",size:"small"})}],m=e=>{var o;const[t,r]=c.useState(e.selectedId||((o=e.options[0])==null?void 0:o.id));return n.jsx(h,{...e,selectedId:t,onSelectionChange:r})},v={render:m,args:{options:d,selectedId:"layout",size:"small"}},T={render:m,args:{options:Ve,selectedId:"layout",size:"small",hoverTextColor:"#2563eb"}},I={render:m,args:{options:Se,selectedId:"computer",size:"small"}},z={render:m,args:{options:d,selectedId:"layout",size:"small",fullWidth:!0},decorators:[e=>n.jsx("div",{style:{width:"400px"},children:n.jsx(e,{})})]},C={render:m,args:{options:Se,selectedId:"computer",size:"small",fullWidth:!0},decorators:[e=>n.jsx("div",{style:{width:"300px"},children:n.jsx(e,{})})]},$={render:m,args:{options:d,selectedId:"layout",size:"small",selectedBgColor:"#e74c3c",selectedTextColor:"#ffffff",hoverBgColor:"#f8f9fa",hoverTextColor:"#e74c3c",containerBgColor:"#f8f9fa"}},B={render:()=>{const[e,t]=c.useState("layout"),[r,o]=c.useState("styling"),[i,u]=c.useState("content");return n.jsxs("div",{style:{display:"flex",flexDirection:"column",gap:"20px",alignItems:"center"},children:[n.jsxs("div",{children:[n.jsx("h3",{children:"Small Size"}),n.jsx(h,{options:d,selectedId:e,onSelectionChange:t,size:"small"})]}),n.jsxs("div",{children:[n.jsx("h3",{children:"Medium Size"}),n.jsx(h,{options:d,selectedId:r,onSelectionChange:o,size:"medium"})]}),n.jsxs("div",{children:[n.jsx("h3",{children:"Large Size"}),n.jsx(h,{options:d,selectedId:i,onSelectionChange:u,size:"large"})]})]})}},E={render:m,args:{options:d,selectedId:"layout",size:"small",disabled:!0}},w={render:m,args:{options:d,selectedId:"layout",size:"small",containerBgColor:"#ffffff",containerBorderColor:"#3b82f6",containerBorderWidth:"2px",selectedBgColor:"#3b82f6",selectedTextColor:"#ffffff"}},j={render:m,args:{options:d,selectedId:"layout",size:"small",gap:"12px"}};var N,H,A;v.parameters={...v.parameters,docs:{...(N=v.parameters)==null?void 0:N.docs,source:{originalSource:`{
  render: Template,
  args: {
...
}`,...(ce=(ae=B.parameters)==null?void 0:ae.docs)==null?void 0:ce.source}}};var de,me,pe;E.parameters={...E.parameters,docs:{...(de=E.parameters)==null?void 0:de.docs,source:{originalSource:`{
  render: Template,
  args: {
    options: basicOptions,
    selectedId: 'layout',
...
}`,...(xe=(ye=j.parameters)==null?void 0:ye.docs)==null?void 0:xe.source}}};const ut=["Default","WithIcons","IconOnly","FullWidth","FullWidthIconOnly","CustomColors","DifferentSizes","Disabled","CustomBorder","CustomGap"];export{w as CustomBorder,$ as CustomColors,j as CustomGap,v as Default,B as DifferentSizes,E as Disabled,z as FullWidth,C as FullWidthIconOnly,I as IconOnly,T as WithIcons,ut as __namedExportsOrder,pt as default};
