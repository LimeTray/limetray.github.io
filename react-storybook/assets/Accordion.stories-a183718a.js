...
`,Qe=l(k.Title)`
  &.icon-position-child.icon-position-child {
    ...
    flex-direction: row;
    justify-content: space-between;
    background-color: ${({isSelected:e,darkMode:t,theme:i})=>e?t?i.colors.darkModeBorder:"#E8F5E9":t?i.colors.darkModeBg:i.colors.white};
    border-top: ${({$hideBorders:e,darkMode:t,theme:i})=>e?"none":`1px solid ${t?i.colors.darkModeBorder:i.colors.border}`};
    cursor: pointer;
    transition: background-color 0.2s ease;
    
    &:hover {
      background-color: ${({isSelected:e,darkMode:t,theme:i})=>e?t?i.colors.darkModeBorder:"#E8F5E9":t?i.colors.darkModeBorder:"#F5F5F5"};
    }
  }
`,et=l.div`
  display: flex;
...
`,ee=l(ze)`
  &.icon {
    color: ${({isOpen:e,darkMode:t,theme:i})=>e?i.colors.primary:t?i.colors.darkModeText:i.colors.text};
  }
`,tt=l.p`
  && {
    padding: 1.5rem;
...
`,it=l.div`
  ...
  border-top: 1px solid ${({darkMode:e,theme:t})=>e?t.colors.darkModeBorder:t.colors.border};
  background-color: ${({darkMode:e,theme:t})=>e?t.colors.darkModeBg:t.colors.white};
`;function rt(){let[e,t]=w.useState(!0);return()=>t(!e)}const Ee=({data:e,defaultOpenSection:t=-1,defaultOpenAll:i=!1,exclusive:m=!1,showChildrenCount:x=!1,onChildClick:$,childrenGap:W,hideBorders:v=!1})=>{const a=Ve().theme==="dark",[s,j]=w.useState({}),[P,Pe]=w.useState({}),[c,Te]=w.useState(null),M=rt();w.useEffect(()=>{const n={};e.forEach((d,p)=>{n[p]=n[p]||{isOpened:!1,childIndex:{}},d.children&&d.children.forEach((f,O)=>{n[p].childIndex[O]={isOpened:!1}})}),Pe(n);const r=JSON.parse(JSON.stringify(n));i?e.forEach((d,p)=>{r[p].isOpened=!0}):t!==-1&&(r[t].isOpened=!0),j(r)},[]);const qe=n=>{if(m&&!s[n].isOpened){const r=JSON.parse(JSON.stringify(P));return r[n].isOpened=!0,j(r),M()}return s[n].isOpened=!s[n].isOpened,j(s),M()},Ge=(n,r)=>{if(m&&!s[n].childIndex[r].isOpened){const d=JSON.parse(JSON.stringify(P));return d[n].isOpened=!0,d[n].childIndex[r].isOpened=!0,j(d),M()}return s[n].childIndex[r].isOpened=!s[n].childIndex[r].isOpened,j(s),M()},De=n=>{qe(n)},T=(n,r)=>{var d,p;if(Ge(n,r),Te({parentIndex:n,childIndex:r}),$){const f=(p=(d=e[n])==null?void 0:d.children)==null?void 0:p[r];f&&$(n,r,f)}};return o.jsx(Je,{theme:Ue,children:o.jsx(_e,{fluid:!0,styled:!0,className:"lt-accordian",darkMode:a,children:e.map((n,r)=>{var d,p,f,O;return o.jsxs(K.Fragment,{children:[o.jsxs(He,{active:(d=s[r])==null?void 0:d.isOpened,index:r,id:n.id,onClick:()=>De(r),className:"round-border",darkMode:a,children:[o.jsx(Ye,{children:o.jsx(E,{darkMode:a,children:n.title})}),o.jsxs(Ze,{children:[x&&n.children&&n.children.length>0&&o.jsx(Ke,{darkMode:a,children:n.children.length}),o.jsx(Q,{children:o.jsx(ee,{isOpen:(p=s[r])==null?void 0:p.isOpened,darkMode:a,size:"small",name:(f=s[r])!=null&&f.isOpened?"chevron up":"chevron down"})})]})]}),o.jsxs(k.Content,{active:(O=s[r])==null?void 0:O.isOpened,children:[n.content&&o.jsx(tt,{darkMode:a,children:n.content}),n.children&&o.jsx(Xe,{className:"lt-child-accordian",fluid:!0,styled:!0,darkMode:a,$childrenGap:W,children:n.children.map((g,u)=>{var q,G,D,z,J,U,V,_,X,H,Y,Z;return g.expandable!==!1&&g.content?o.jsxs(K.Fragment,{children:[o.jsxs(Qe,{id:g.id,className:"icon-position-child",active:(D=(G=(q=s[r])==null?void 0:q.childIndex)==null?void 0:G[u])==null?void 0:D.isOpened,index:u,onClick:()=>T(r,u),darkMode:a,$hideBorders:v,isSelected:(c==null?void 0:c.parentIndex)===r&&(c==null?void 0:c.childIndex)===u,children:[o.jsx(E,{isChild:!0,darkMode:a,children:g.title}),o.jsx(Q,{children:o.jsx(ee,{isOpen:(U=(J=(z=s[r])==null?void 0:z.childIndex)==null?void 0:J[u])==null?void 0:U.isOpened,darkMode:a,size:"small",name:(X=(_=(V=s[r])==null?void 0:V.childIndex)==null?void 0:_[u])!=null&&X.isOpened?"chevron up":"chevron down"})})]}),o.jsx(k.Content,{active:(Z=(Y=(H=s[r])==null?void 0:H.childIndex)==null?void 0:Y[u])==null?void 0:Z.isOpened,children:o.jsx(ot,{darkMode:a,children:g.content})})]},u):o.jsx(et,{darkMode:a,$hideBorders:v,isSelected:(c==null?void 0:c.parentIndex)===r&&(c==null?void 0:c.childIndex)===u,onClick:()=>T(r,u),children:o.jsx(E,{isChild:!0,darkMode:a,children:g.title})},u)})}),n.bottomComponent?o.jsx(it,{darkMode:a,children:n.bottomComponent}):n.bottomButton?o.jsx(nt,{darkMode:a,onClick:n.bottomButton.onClick,children:n.bottomButton.label}):null]})]},r)})})})},F=Ee;Ee.__docgenInfo={description:"",methods:[],displayName:"LtAccordion",props:{data:{required:!0,tsType:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
...
Demonstrates using custom React components as child titles
Icons can be React components (like LtIcon) or emojis`,...(we=(je=y.parameters)==null?void 0:je.docs)==null?void 0:we.description}}};var Be,Se,Ae;L.parameters={...L.parameters,docs:{...(Be=L.parameters)==null?void 0:Be.docs,source:{originalSource:"(args: LtAccordionProps) => <LtAccordion {...args} />",...(Ae=(Se=L.parameters)==null?void 0:Se.docs)==null?void 0:Ae.source}}};var Le,Re,Ie;R.parameters={...R.parameters,docs:{...(Le=R.parameters)==null?void 0:Le.docs,source:{originalSource:"(args: LtAccordionProps) => <LtAccordion {...args} />",...(Ie=(Re=R.parameters)==null?void 0:Re.docs)==null?void 0:Ie.source}}};var Ne,Fe,$e;I.parameters={...I.parameters,docs:{...(Ne=I.parameters)==null?void 0:Ne.docs,source:{originalSource:`() => {
...
}`,...($e=(Fe=I.parameters)==null?void 0:Fe.docs)==null?void 0:$e.source}}};var Me,Oe,We;N.parameters={...N.parameters,docs:{...(Me=N.parameters)==null?void 0:Me.docs,source:{originalSource:`() => {
  const CustomFooter = ({
    sectionName
  }: {
    sectionName: string;
...
}`,...(We=(Oe=N.parameters)==null?void 0:Oe.docs)==null?void 0:We.source}}};const Rt=["Default","WithoutNestedItems","SingleAccordion","DefaultOpenAll","WithChildrenGaps","WithReactComponentChildren","WithChildrenCount","WithBottomButton","WithChildSelection","WithCustomBottomComponent"];export{B as Default,b as DefaultOpenAll,A as SingleAccordion,R as WithBottomButton,I as WithChildSelection,L as WithChildrenCount,C as WithChildrenGaps,N as WithCustomBottomComponent,y as WithReactComponentChildren,S as WithoutNestedItems,Rt as __namedExportsOrder,Lt as default};
