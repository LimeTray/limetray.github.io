import{j as r}from"./jsx-runtime-8ae9c9ad.js";import{L as O}from"./ltButton-466fbc29.js";import{I as o}from"./Icon-6945f610.js";import"./index-04c7fd94.js";import"./_commonjsHelpers-725317a4.js";import"./Button-8d24c33b.js";import"./getElementType-acd63778.js";import"./invoke-58a3b25b.js";import"./factories-559e568f.js";import"./clsx.m-b06f1f65.js";import"./childrenUtils-d21e35d1.js";import"./get-2a449dd5.js";import"./Label-c1a3398d.js";import"./ModernAutoControlledComponent-9145494f.js";import"./htmlPropsUtils-c8ab4bb9.js";import"./includes-ceab992c.js";import"./Portal-f57c5e74.js";import"./index-4348461f.js";import"./Ref-0746b26a.js";import"./objectWithoutPropertiesLoose-75170e70.js";import"./map-d105d6f1.js";import"./styled-components.browser.esm-b57a6336.js";import"./index-019b0ce5.js";import"./Dropdown-4796e13c.js";import"./without-b20c73c8.js";import"./isEmpty-0f216811.js";import"./deburr-bb2546ff.js";import"./pick-76e2c856.js";import"./_baseSet-aac0c625.js";import"./index-edc4e742.js";import"./_arrayReduce-865b0d3f.js";import"./tickIcon-9f7569d5.js";import"./config-d270d9b6.js";import"./index-9e8f50bb.js";const ke={component:O,title:"Button",tags:["autodocs"]},A={borderRadius:"50px",border:"1px solid rgba(209, 213, 219, 1)",backgroundColor:"white"},e=()=>{alert("Button clicked")},t={args:{label:"default",onClick:e}},n={args:{label:"click me",size:"medium",onClick:e,customStyles:A,leftElement:r.jsx(o,{fitted:!0,name:"filter",size:"small",color:"green"}),rightElement:r.jsx(o,{fitted:!0,name:"arrow right",size:"small",color:"blue"})}},l={args:{label:"Apply filter",size:"small",onClick:e,transparent:!0,leftElement:r.jsx(o,{fitted:!0,name:"filter",size:"small",color:"green"}),rightElement:r.jsx(o,{fitted:!0,name:"arrow right",size:"small",color:"blue"})}},s={args:{label:"Disabled Button",size:"small",onClick:e,disabled:!0}},a={args:{label:"Select Categories",size:"small",onClick:e,customStyles:A,alignItemCenter:!0,leftElement:r.jsx(o,{fitted:!0,name:"plus",size:"small",color:"green"}),rightElement:r.jsx("span",{style:{color:"white",backgroundColor:"red",paddingRight:"5px",paddingLeft:"5px",borderRadius:"90%"},children:"14"})}},i={args:{label:"Styled Button",size:"small",onClick:e,backgroundColor:"#7b39ed",color:"#ffffff",padding:"12px 24px",width:"200px",hoverBackgroundColor:"#8541fa",hoverColor:"#ffffff",alignItemCenter:!0}},d={args:{label:"Custom Border",size:"small",onClick:e,border:!0,borderStyles:{width:"2px",type:"dashed",color:"#7b39ed",radius:"8px"}}},c={args:{label:"Publish",size:"medium",onClick:e,backgroundColor:"#1f2947",color:"#ffffff",hoverBackgroundColor:"#283456",hoverColor:"#ffffff",padding:"14px 24px",border:!0,borderStyles:{width:"1px",type:"solid",color:"#1f2947",radius:"8px"},menuDropdownOptions:[{text:"Publish now",id:"publish-now"},{text:"Schedule publish",id:"schedule-publish"},{text:"Save as draft",id:"save-as-draft"}],onMenuDropdownClick:(P,$)=>alert(`Menu option ${P}: ${$.text}`),menuDropdownHoverStyles:{backgroundColor:"#eef2ff",contentColor:"#1f2947"}}};var m,p,u;t.parameters={...t.parameters,docs:{...(m=t.parameters)==null?void 0:m.docs,source:{originalSource:`{
  args: {
    label: "default",
    onClick: handleClick
  }
...
}`,...(S=(B=s.parameters)==null?void 0:B.docs)==null?void 0:S.source}}};var z,w,y;a.parameters={...a.parameters,docs:{...(z=a.parameters)==null?void 0:z.docs,source:{originalSource:`{
  args: {
...
}`,...(y=(w=a.parameters)==null?void 0:w.docs)==null?void 0:y.source}}};var E,v,I;i.parameters={...i.parameters,docs:{...(E=i.parameters)==null?void 0:E.docs,source:{originalSource:`{
  args: {
    label: "Styled Button",
    size: "small",
    onClick: handleClick,
...
}`,...(I=(v=i.parameters)==null?void 0:v.docs)==null?void 0:I.source}}};var D,W,j;d.parameters={...d.parameters,docs:{...(D=d.parameters)==null?void 0:D.docs,source:{originalSource:`{
  args: {
    label: "Custom Border",
    size: "small",
    onClick: handleClick,
