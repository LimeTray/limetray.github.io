import{j as t}from"./jsx-runtime-8ae9c9ad.js";import{B as k}from"./Button-8d24c33b.js";import{g as u,f as z}from"./styled-components.browser.esm-b57a6336.js";import{M as O}from"./index-019b0ce5.js";import{L as W}from"./index-9e8f50bb.js";import{t as A}from"./config-d270d9b6.js";const h=e=>(e==null?void 0:e.radius)||"24px",Y=(e,r)=>{if(!e)return"border: none;";if(r){const{width:n="1px",type:o="solid",color:a="rgb(209, 213, 219)"}=r;return`border: ${n} ${o} ${a};`}return"border: 1px solid rgb(209, 213, 219);"},I={mini:"32px",tiny:"36px",small:"40px",medium:"44px",large:"48px",big:"52px",huge:"56px",massive:"60px"},j={mini:"mini",tiny:"tiny",small:"small",medium:"small",large:"medium",big:"medium",huge:"large",massive:"large"},b=(e="small")=>I[e]||I.small,K=(e="small")=>j[e]||j.small,U=e=>{if(!e)return;const r=e.trim().split(/\s+/);return r.length===1?`${r[0]} 0`:r.length===2?`${r[0]} 0`:r.length===3?`${r[0]} 0 ${r[2]}`:`${r[0]} 0 ${r[2]} 0`},N=()=>z`
...
`,Q=u(k)`
  &&& {
    ...
    padding: ${e=>U(e.$padding)||"0.78571429em 0"};
    box-shadow: none;
  }
