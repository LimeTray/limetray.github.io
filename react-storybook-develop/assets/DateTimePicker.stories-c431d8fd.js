import{j as n}from"./jsx-runtime-8ae9c9ad.js";import{r as c}from"./index-04c7fd94.js";import{O as be}from"./index-4348461f.js";import{C as qt}from"./calendarOutline-2e35b970.js";import{C as Ft}from"./closeIcon-47679e6f.js";import{L as Z}from"./index-9e8f50bb.js";import{S as Nt}from"./stringConstants-3a2e7b32.js";import{E as Q,g as s,f as k}from"./styled-components.browser.esm-b57a6336.js";import"./_commonjsHelpers-725317a4.js";import"./Button-8d24c33b.js";import"./getElementType-acd63778.js";import"./invoke-58a3b25b.js";import"./factories-559e568f.js";import"./clsx.m-b06f1f65.js";import"./childrenUtils-d21e35d1.js";import"./get-2a449dd5.js";import"./Icon-6945f610.js";import"./Label-c1a3398d.js";import"./ModernAutoControlledComponent-9145494f.js";import"./htmlPropsUtils-c8ab4bb9.js";import"./includes-ceab992c.js";import"./Portal-f57c5e74.js";import"./Ref-0746b26a.js";import"./objectWithoutPropertiesLoose-75170e70.js";import"./map-d105d6f1.js";Q`
  from {
    opacity: 0;
...
`,{DATE_TIME_PICKER:h}=Nt,we=e=>e.toLocaleDateString("en-US",{month:"short",day:"numeric",year:"numeric"}),ye=e=>{try{let i=e;return e.split(":").length===2&&(i=`${e}:00`),new Date(`2000-01-01T${i}`).toLocaleTimeString("en-US",{hour:"numeric",minute:"2-digit",hour12:!0})}catch{return e}},ve=(e,i)=>e.getFullYear()===i.getFullYear()&&e.getMonth()===i.getMonth()&&e.getDate()===i.getDate(),ie=()=>{const e=new Date,i=e.getHours().toString().padStart(2,"0"),l=e.getMinutes().toString().padStart(2,"0");return`${i}:${l}`},Mn=(e,i)=>{const[l,y]=i.split(":").map(Number),$=new Date(e);return $.setHours(l,y,0,0),$},bt=({value:e,onChange:i,includeTime:l=!1,includeYearSelection:y=!1,disabled:$=!1,error:T=!1,popoverTitle:U,minDate:f,maxDate:v,customStyles:xt={},placeholder:V})=>{const[m,K]=c.useState(!1),[u,S]=c.useState(()=>{if(e){if(typeof e=="number")return new Date(e);if(typeof e=="string"){const t=new Date(e);return isNaN(t.getTime())?V?null:new Date:t}else{if(e instanceof Date)return e;if(typeof e=="object"&&e!==null&&"epoch"in e)return new Date(e.date)}}return V?null:new Date}),[G,M]=c.useState(ie()),[de,b]=c.useState(()=>{if(e){if(typeof e=="number")return new Date(e);if(typeof e=="string"){const t=new Date(e);return isNaN(t.getTime())?new Date:t}else{if(e instanceof Date)return e;if(typeof e=="object"&&e!==null&&"epoch"in e)return new Date(e.date)}}return new Date}),[$t,ce]=c.useState(""),[wt,Y]=c.useState(!1),C=c.useRef(null),ne=c.useRef(null),[r,yt]=c.useState(window.innerWidth<768),[ue,pe]=c.useState({top:0,left:0});c.useEffect(()=>{const t=()=>{yt(window.innerWidth<768)};return window.addEventListener("resize",t),()=>window.removeEventListener("resize",t)},[]),c.useEffect(()=>{if(e)if(typeof e=="number"){const t=new Date(e);if(S(t),b(t),l){const a=t.getHours().toString().padStart(2,"0"),o=t.getMinutes().toString().padStart(2,"0");M(`${a}:${o}`)}}else if(typeof e=="string"){const t=new Date(e);if(!isNaN(t.getTime())&&(S(t),b(t),l)){const a=t.getHours().toString().padStart(2,"0"),o=t.getMinutes().toString().padStart(2,"0");M(`${a}:${o}`)}}else if(e instanceof Date){if(S(e),b(e),l){const t=e.getHours().toString().padStart(2,"0"),a=e.getMinutes().toString().padStart(2,"0");M(`${t}:${a}`)}}else typeof e=="object"&&e!==null&&"epoch"in e&&(S(new Date(e.date)),b(new Date(e.date)),l&&e.time?M(e.time):l&&M(ie()));else if(V)S(null),b(new Date);else{const t=new Date;S(t),b(t),l&&M(ie())}},[e,l,V]),c.useEffect(()=>{if(u){let t=we(u);l&&(t+=` (${ye(G)})`),ce(t)}else ce("")},[u,G,l]),c.useEffect(()=>{const t=a=>{m&&ne.current&&!ne.current.contains(a.target)&&C.current&&!C.current.contains(a.target)&&K(!1)};return document.addEventListener("mousedown",t),()=>document.removeEventListener("mousedown",t)},[m]);const vt=t=>f?t<new Date(f.getFullYear(),f.getMonth(),f.getDate()):!1,Dt=t=>v?t>new Date(v.getFullYear(),v.getMonth(),v.getDate()):!1,ge=t=>vt(t)||Dt(t),St=t=>{ge(t)||S(t)},Mt=()=>{b(t=>{const a=new Date(t);return a.setMonth(a.getMonth()-1),f&&a<new Date(f.getFullYear(),f.getMonth(),1)?t:a})},Ct=()=>{b(t=>{const a=new Date(t);return a.setMonth(a.getMonth()+1),v&&a>new Date(v.getFullYear(),v.getMonth(),1)?t:a})},ee=()=>{const t=new Date,a=t.getFullYear()-100,o=t.getFullYear()+10,d=f?f.getFullYear():a,p=v?v.getFullYear():o;return{minYear:d,maxYear:p}},kt=t=>{b(a=>{const o=new Date(a);return o.setFullYear(t),o}),Y(!1)},J=12,ae=()=>{const{minYear:t,maxYear:a}=ee(),o=de.getFullYear(),d=Math.floor((o-t)/J)*J+t,p=Math.min(d+J-1,a);return{start:d,end:Math.max(p,d)}},Tt=()=>{const{start:t}=ae(),a=Math.max(ee().minYear,t-J);b(o=>{const d=new Date(o);return d.setFullYear(a),d})},Vt=()=>{const{end:t}=ae(),a=Math.min(ee().maxYear,t+J);b(o=>{const d=new Date(o);return d.setFullYear(a),d})},Yt=(t,a)=>{let o;if(l&&a)o=Mn(t,a).getTime();else{const d=new Date(t);d.setHours(12,0,0,0),o=d.getTime()}return{epoch:o,date:t.toISOString(),time:l?a:null}},jt=()=>{if(!u)return;const t=Yt(u,l?G:null);i(t),K(!1)},Wt=t=>{const a=t.getFullYear(),o=t.getMonth(),p=new Date(a,o,1).getDay(),re=new Date(a,o+1,0).getDate(),X=[];if(p>0){const fe=new Date(a,o,0).getDate();for(let oe=fe-p+1;oe<=fe;oe++)X.push(new Date(a,o-1,oe))}const x=[];for(let D=1;D<=re;D++)x.push(new Date(a,o,D));const Rt=42-X.length-x.length,he=[];for(let D=1;D<=Rt;D++)he.push(new Date(a,o+1,D));return[...X,...x,...he]},Pt=(t,a=!0)=>{const o=u?ve(t,u):!1,d=ge(t),w=ve(t,new Date);return n.jsx(bn,{$isCurrentMonth:a,$isSelected:o,$isToday:w,$isMobile:r,$isDisabled:d,onClick:()=>St(t),children:t.getDate()},t.toISOString())},Et=()=>{const{start:t,end:a}=ae(),{minYear:o,maxYear:d}=ee(),p=Array.from({length:a-t+1},(x,me)=>t+me),w=new Date,re=w.getFullYear(),X=u?u.getFullYear():w.getFullYear();return n.jsxs(n.Fragment,{children:[n.jsxs(xe,{$isMobile:r,children:[n.jsx(te,{$isMobile:r,onClick:Tt,disabled:t<=o,children:n.jsx(Z,{useReactIcon:!0,reactIconName:"MdChevronLeft",reactIconSet:"md",className:"range-selector-icon",size:"small"})}),n.jsxs(dn,{type:"button",onClick:()=>Y(!1),children:[t," – ",a]}),n.jsx(te,{$isMobile:r,onClick:Vt,disabled:a>=d,children:n.jsx(Z,{useReactIcon:!0,reactIconName:"MdChevronRight",reactIconSet:"md",className:"range-selector-icon",size:"small"})})]}),n.jsx(pn,{$isMobile:r,children:p.map(x=>n.jsx(gn,{$isSelected:x===X,$isCurrentYear:x===re,$isMobile:r,$isDisabled:x<o||x>d,onClick:()=>kt(x),children:x},x))})]})},Ot=t=>{const a=t.toLocaleString("default",{month:"long"}),o=t.getFullYear(),d=Wt(t),p=[h.DAYS_OF_WEEK.SUNDAY,h.DAYS_OF_WEEK.MONDAY,h.DAYS_OF_WEEK.TUESDAY,h.DAYS_OF_WEEK.WEDNESDAY,h.DAYS_OF_WEEK.THURSDAY,h.DAYS_OF_WEEK.FRIDAY,h.DAYS_OF_WEEK.SATURDAY];return n.jsxs(n.Fragment,{children:[n.jsxs(xe,{$isMobile:r,children:[n.jsx(te,{$isMobile:r,onClick:Mt,children:n.jsx(Z,{useReactIcon:!0,reactIconName:"MdChevronLeft",reactIconSet:"md",className:"range-selector-icon",size:"small"})}),n.jsxs(ln,{$isMobile:r,children:[n.jsx(cn,{children:y?a:`${a} ${o}`}),y&&n.jsx(un,{$isMobile:r,onClick:()=>Y(!0),type:"button","aria-label":h.YEAR,children:o})]}),n.jsx(te,{$isMobile:r,onClick:Ct,children:n.jsx(Z,{useReactIcon:!0,reactIconName:"MdChevronRight",reactIconSet:"md",className:"range-selector-icon",size:"small"})})]}),n.jsx(mn,{$isMobile:r,children:p.map(w=>n.jsx(hn,{$isMobile:r,children:w},w))}),n.jsx(fn,{$isMobile:r,children:d.map(w=>Pt(w,w.getMonth()===t.getMonth()))})]})},It=()=>{if(!$){if(!m&&!r&&C.current){const t=C.current.getBoundingClientRect(),a=400,o=8,d=window.innerHeight-t.bottom,p=d<a&&t.top>d;pe({top:p?t.top-a-o:t.bottom+o,left:Math.max(8,Math.min(t.left,window.innerWidth-356))})}K(!m),m||(b(u||new Date),Y(!1))}};c.useEffect(()=>(r&&m?document.body.style.overflow="hidden":document.body.style.overflow="",()=>{document.body.style.overflow=""}),[r,m]),c.useLayoutEffect(()=>{if(!r&&m&&C.current){const t=C.current.getBoundingClientRect(),a=400,o=8,d=window.innerHeight-t.bottom,p=d<a&&t.top>d;pe({top:p?t.top-a-o:t.bottom+o,left:Math.max(8,Math.min(t.left,window.innerWidth-356))})}},[r,m]);const At=U||(l?h.SELECT_DATE_TIME:h.SELECT_DATE),zt=n.jsxs(n.Fragment,{children:[n.jsxs(Qt,{$isMobile:r,children:[n.jsx(en,{$isMobile:r,children:At}),n.jsx(tn,{$isMobile:r,onClick:()=>{K(!1),Y(!1)},children:n.jsx(Ft,{style:{width:"10px",height:"10px"},strokeColor:"#6b7280"})})]}),n.jsxs("div",{children:[n.jsxs(nn,{children:[n.jsx(xn,{$isMobile:r,children:n.jsxs($n,{$isMobile:r,children:[u?we(u):V||"Select date",u&&l&&` (${ye(G)})`]})}),n.jsxs(an,{$includeTime:l,$isMobile:r,children:[n.jsx(rn,{$isMobile:r,$includeTime:l,children:n.jsx(on,{children:y&&wt?Et():Ot(de)})}),l&&n.jsx(sn,{$isMobile:r,children:n.jsxs(wn,{$isMobile:r,children:[n.jsx(yn,{children:h.TIME}),n.jsx(vn,{type:"time",$isMobile:r,value:G,onChange:t=>M(t.target.value),onClick:t=>{const a=t.currentTarget;typeof a.showPicker=="function"&&a.showPicker()}})]})})]})]}),n.jsxs(Dn,{$isMobile:r,children:[n.jsx($e,{$variant:"cancel",$isMobile:r,onClick:()=>{K(!1),Y(!1)},children:h.CANCEL}),n.jsx($e,{$variant:"apply",$isMobile:r,onClick:jt,disabled:!u,children:h.APPLY})]})]})]});return n.jsxs(Ut,{children:[n.jsxs(se,{$isMobile:r,$isOpen:m,$hasError:T,$isDisabled:$,$customStyles:xt,onClick:$?void 0:It,ref:C,children:[n.jsx(Kt,{$isMobile:r,children:n.jsx(qt,{width:"20px"})}),n.jsx(Gt,{$isMobile:r,$isPlaceholder:!u,children:u?$t:V||"Select date"}),n.jsx(Jt,{$isOpen:m,children:n.jsx(Z,{useReactIcon:!0,reactIconName:"MdExpandMore",reactIconSet:"md",className:"range-selector-icon",size:"medium"})})]}),r&&m&&be.createPortal(n.jsx(Sn,{}),document.body),m&&be.createPortal(n.jsx(Xt,{$isMobile:r,$isOpen:m,$top:r?void 0:ue.top,$left:r?void 0:ue.left,ref:ne,children:n.jsx(Zt,{$isMobile:r,$includeTime:l,children:zt})}),document.body)]})},le=bt;bt.__docgenInfo={description:"",methods:[],displayName:"DateTimePicker",props:{value:{required:!1,tsType:{name:"union",raw:`Date | number | string | {
  epoch: number;
  date: string;
  time: string | null;
...
}`,...(ct=(dt=L.parameters)==null?void 0:dt.docs)==null?void 0:ct.source}}};var ut,pt,gt;H.parameters={...H.parameters,docs:{...(ut=H.parameters)==null?void 0:ut.docs,source:{originalSource:`args => {
  const [value, setValue] = useState<ValueType>(args.value);
  const handleChange = (newValue: {
    epoch: number;
    date: string;
...
}`,...(gt=(pt=H.parameters)==null?void 0:pt.docs)==null?void 0:gt.source}}};var mt,ht,ft;B.parameters={...B.parameters,docs:{...(mt=B.parameters)==null?void 0:mt.docs,source:{originalSource:`args => {
  const [value, setValue] = useState<ValueType>(args.value);
  const handleChange = (newValue: {
    epoch: number;
    date: string;
