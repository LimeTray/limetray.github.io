import{j as o}from"./jsx-runtime-8406ef1e.js";import{r as S,R as K}from"./index-ad58220e.js";import{A as k}from"./Accordion-3a01cb70.js";import{d as l,o as ze}from"./styled-components.browser.esm-675ea4f2.js";import{L as Je}from"./index-ab607697.js";import{t as Ue}from"./config-43c6afbd.js";import{u as Ve}from"./ThemeContext-71b3bf8d.js";import"./_commonjsHelpers-de833af9.js";import"./extends-4c19d496.js";import"./getElementType-ff0d42f5.js";import"./inheritsLoose-5494d9cc.js";import"./map-20538cdf.js";import"./childrenUtils-dd3b0ba5.js";import"./factories-f5adea19.js";import"./without-07d2399e.js";import"./includes-8058702b.js";import"./objectWithoutPropertiesLoose-f3b3ace0.js";import"./index-4fee7e45.js";import"./ModernAutoControlledComponent-fe68b7fb.js";import"./assertThisInitialized-081f9914.js";import"./Icon-33b7fdc8.js";import"./Button-a662ac97.js";import"./Label-541ced09.js";import"./htmlPropsUtils-923b414b.js";import"./Portal-50130825.js";const _e=l(k)`
  &.ui.fluid.accordion {
...
`,it=l.div`
  ...
  border-top: 1px solid ${({darkMode:e,theme:t})=>e?t.colors.darkModeBorder:t.colors.border};
  background-color: ${({darkMode:e,theme:t})=>e?t.colors.darkModeBg:t.colors.white};
`;function rt(){let[e,t]=S.useState(!0);return()=>t(!e)}const Ee=({data:e,defaultOpenSection:t=-1,defaultOpenAll:r=!1,exclusive:m=!1,showChildrenCount:x=!1,onChildClick:M,childrenGap:W,hideBorders:v=!1})=>{const a=Ve().theme==="dark",[s,j]=S.useState({}),[P,Pe]=S.useState({}),[f,Te]=S.useState(null),$=rt();S.useEffect(()=>{const n={};e.forEach((d,c)=>{n[c]=n[c]||{isOpened:!1,childIndex:{}},d.children&&d.children.forEach((g,O)=>{n[c].childIndex[O]={isOpened:!1}})}),Pe(n);const i=JSON.parse(JSON.stringify(n));r?e.forEach((d,c)=>{i[c].isOpened=!0}):t!==-1&&(i[t].isOpened=!0),j(i)},[]);const qe=n=>{if(m&&!s[n].isOpened){const i=JSON.parse(JSON.stringify(P));return i[n].isOpened=!0,j(i),$()}return s[n].isOpened=!s[n].isOpened,j(s),$()},Ge=(n,i)=>{if(m&&!s[n].childIndex[i].isOpened){const d=JSON.parse(JSON.stringify(P));return d[n].isOpened=!0,d[n].childIndex[i].isOpened=!0,j(d),$()}return s[n].childIndex[i].isOpened=!s[n].childIndex[i].isOpened,j(s),$()},De=n=>{qe(n)},T=(n,i)=>{var d,c;if(Ge(n,i),Te({parentIndex:n,childIndex:i}),M){const g=(c=(d=e[n])==null?void 0:d.children)==null?void 0:c[i];g&&M(n,i,g)}};return o.jsx(ze,{theme:Ue,children:o.jsx(_e,{fluid:!0,styled:!0,className:"lt-accordian",darkMode:a,children:e.map((n,i)=>{var d,c,g,O;return o.jsxs(K.Fragment,{children:[o.jsxs(He,{active:(d=s[i])==null?void 0:d.isOpened,index:i,id:n.id,onClick:()=>De(i),className:"round-border",darkMode:a,children:[o.jsx(Ye,{children:typeof n.title=="string"?o.jsx(E,{darkMode:a,children:n.title}):n.title}),o.jsxs(Ze,{children:[x&&n.children&&n.children.length>0&&o.jsx(Ke,{darkMode:a,children:n.children.length}),o.jsx(Q,{children:o.jsx(ee,{useReactIcon:!0,reactIconName:(c=s[i])!=null&&c.isOpened?"MdExpandLess":"MdExpandMore",reactIconSet:"md",fitted:!0,isOpen:(g=s[i])==null?void 0:g.isOpened,darkMode:a,size:"small"})})]})]}),o.jsxs(k.Content,{active:(O=s[i])==null?void 0:O.isOpened,children:[n.content&&o.jsx(tt,{darkMode:a,children:n.content}),n.children&&o.jsx(Xe,{className:"lt-child-accordian",fluid:!0,styled:!0,darkMode:a,$childrenGap:W,children:n.children.map((p,u)=>{var q,G,D,z,J,U,V,_,X,H,Y,Z;return p.expandable!==!1&&p.content?o.jsxs(K.Fragment,{children:[o.jsxs(Qe,{id:p.id,className:"icon-position-child",active:(D=(G=(q=s[i])==null?void 0:q.childIndex)==null?void 0:G[u])==null?void 0:D.isOpened,index:u,onClick:()=>T(i,u),darkMode:a,$hideBorders:v,isSelected:(f==null?void 0:f.parentIndex)===i&&(f==null?void 0:f.childIndex)===u,children:[typeof p.title=="string"?o.jsx(E,{isChild:!0,darkMode:a,children:p.title}):p.title,o.jsx(Q,{children:o.jsx(ee,{useReactIcon:!0,reactIconName:(U=(J=(z=s[i])==null?void 0:z.childIndex)==null?void 0:J[u])!=null&&U.isOpened?"MdExpandLess":"MdExpandMore",reactIconSet:"md",fitted:!0,isOpen:(X=(_=(V=s[i])==null?void 0:V.childIndex)==null?void 0:_[u])==null?void 0:X.isOpened,darkMode:a,size:"small"})})]}),o.jsx(k.Content,{active:(Z=(Y=(H=s[i])==null?void 0:H.childIndex)==null?void 0:Y[u])==null?void 0:Z.isOpened,children:o.jsx(ot,{darkMode:a,children:p.content})})]},u):o.jsx(et,{darkMode:a,$hideBorders:v,onClick:()=>T(i,u),children:typeof p.title=="string"?o.jsx(E,{isChild:!0,darkMode:a,children:p.title}):p.title},u)})}),n.bottomComponent?o.jsx(it,{darkMode:a,children:n.bottomComponent}):n.bottomButton?o.jsx(nt,{darkMode:a,onClick:n.bottomButton.onClick,children:n.bottomButton.label}):null]})]},i)})})})},F=Ee;Ee.__docgenInfo={description:"",methods:[],displayName:"LtAccordion",props:{data:{required:!0,tsType:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
...
Shows children with spacing between them instead of borders`,...(Ce=(be=C.parameters)==null?void 0:be.docs)==null?void 0:Ce.description}}};var ye,ke,ve,je,Se;y.parameters={...y.parameters,docs:{...(ye=y.parameters)==null?void 0:ye.docs,source:{originalSource:`() => {
...
Demonstrates using custom React components as child titles
Icons can be React components (like LtIcon) or emojis`,...(Se=(je=y.parameters)==null?void 0:je.docs)==null?void 0:Se.description}}};var we,Be,Ae;L.parameters={...L.parameters,docs:{...(we=L.parameters)==null?void 0:we.docs,source:{originalSource:"(args: LtAccordionProps) => <LtAccordion {...args} />",...(Ae=(Be=L.parameters)==null?void 0:Be.docs)==null?void 0:Ae.source}}};var Le,Re,Ne;R.parameters={...R.parameters,docs:{...(Le=R.parameters)==null?void 0:Le.docs,source:{originalSource:"(args: LtAccordionProps) => <LtAccordion {...args} />",...(Ne=(Re=R.parameters)==null?void 0:Re.docs)==null?void 0:Ne.source}}};var Ie,Fe,Me;N.parameters={...N.parameters,docs:{...(Ie=N.parameters)==null?void 0:Ie.docs,source:{originalSource:`() => {
...
}`,...(Me=(Fe=N.parameters)==null?void 0:Fe.docs)==null?void 0:Me.source}}};var $e,Oe,We;I.parameters={...I.parameters,docs:{...($e=I.parameters)==null?void 0:$e.docs,source:{originalSource:`() => {
  const CustomFooter = ({
    sectionName
  }: {
    sectionName: string;
...
}`,...(We=(Oe=I.parameters)==null?void 0:Oe.docs)==null?void 0:We.source}}};const Wt=["Default","WithoutNestedItems","SingleAccordion","DefaultOpenAll","WithChildrenGaps","WithReactComponentChildren","WithChildrenCount","WithBottomButton","WithChildSelection","WithCustomBottomComponent"];export{w as Default,b as DefaultOpenAll,A as SingleAccordion,R as WithBottomButton,N as WithChildSelection,L as WithChildrenCount,C as WithChildrenGaps,I as WithCustomBottomComponent,y as WithReactComponentChildren,B as WithoutNestedItems,Wt as __namedExportsOrder,Ot as default};
