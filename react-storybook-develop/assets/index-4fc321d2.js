import{j as n}from"./jsx-runtime-8ae9c9ad.js";import{r as R}from"./index-04c7fd94.js";import{g as o,r as D}from"./styled-components.browser.esm-f4af7a4c.js";import{D as s}from"./Dropdown-4796e13c.js";import{T as I}from"./tickIcon-9f7569d5.js";import{t as _}from"./config-d270d9b6.js";const M=o(s)`
  &&&.ui.dropdown {
    & > .menu {
...
`,d=({options:e,triggerComponent:i,pointing:p,className:c,onClick:u,dropdownProps:h,maxHeight:g=300,selectedIndex:f,hoverStyles:r})=>{const[b,m]=R.useState(!1),w=()=>m(t=>!t),x=(r==null?void 0:r.backgroundColor)||"transparent",y=r==null?void 0:r.contentColor,$=(t,a)=>l=>{u(t+1,a)},k=()=>{m(!1)},C=t=>t?n.jsx(P,{children:t}):null;return n.jsx(D,{theme:_,children:n.jsx(M,{...h,$hoverBackgroundColor:x,$hoverContentColor:y,trigger:n.jsx(N,{onClick:w,children:i}),open:b,onClose:k,pointing:p,icon:null,className:c,children:n.jsx(q,{$maxHeight:g,children:e.map((t,a)=>{const{leftIcon:l,contentColor:v,text:T,...j}=t;return n.jsx(s.Item,{...j,onClick:$(a,t),children:n.jsxs(O,{$contentColor:v,children:[n.jsxs(H,{children:[C(l),n.jsx(W,{children:T})]}),f===a+1&&n.jsx(z,{})]})},a)})})})})},V=d;d.__docgenInfo={description:"",methods:[],displayName:"MenuDropdown",props:{options:{required:!0,tsType:{name:"Array",elements:[{name:"MenuDropdownOption"}],raw:"MenuDropdownOption[]"},description:""},triggerComponent:{required:!0,tsType:{name:"ReactReactNode",raw:"React.ReactNode"},description:""},pointing:{required:!1,tsType:{name:"union",raw:`| "left"
| "right"
| "top"
| "bottom"
| "top right"
