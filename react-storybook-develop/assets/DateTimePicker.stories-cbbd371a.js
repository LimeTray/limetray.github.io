import{j as n}from"./jsx-runtime-8ae9c9ad.js";import{r as c}from"./index-04c7fd94.js";import{O as me}from"./index-4348461f.js";import{C as Ot}from"./calendarOutline-2e35b970.js";import{C as It}from"./closeIcon-47679e6f.js";import{L as J}from"./index-9e8f50bb.js";import{S as At}from"./stringConstants-3a2e7b32.js";import{E as X,g as s,f as C}from"./styled-components.browser.esm-b57a6336.js";import"./_commonjsHelpers-725317a4.js";import"./Button-8d24c33b.js";import"./getElementType-acd63778.js";import"./invoke-58a3b25b.js";import"./factories-559e568f.js";import"./clsx.m-b06f1f65.js";import"./childrenUtils-d21e35d1.js";import"./get-2a449dd5.js";import"./Icon-6945f610.js";import"./Label-c1a3398d.js";import"./ModernAutoControlledComponent-9145494f.js";import"./htmlPropsUtils-c8ab4bb9.js";import"./includes-ceab992c.js";import"./Portal-f57c5e74.js";import"./Ref-0746b26a.js";import"./objectWithoutPropertiesLoose-75170e70.js";import"./map-d105d6f1.js";X`
  from {
    opacity: 0;
...
`,pn=s.div`
  ...
  ${e=>e.$isSelected&&!e.$isDisabled&&C`
    animation: ${zt} 0.3s ease-in-out;
  `}

  ${e=>e.$isToday&&!e.$isDisabled&&!e.$isSelected&&C`
    &::after {
      content: '';
      position: absolute;
      bottom: 2px;
      ...
      border-radius: 50%;
      animation: ${qt} 2s ease-in-out infinite;
    }
  `}
`,gn=s.div`
  display: flex;
...
`,{DATE_TIME_PICKER:m}=At,fe=e=>e.toLocaleDateString("en-US",{month:"short",day:"numeric",year:"numeric"}),xe=e=>{try{let i=e;return e.split(":").length===2&&(i=`${e}:00`),new Date(`2000-01-01T${i}`).toLocaleTimeString("en-US",{hour:"numeric",minute:"2-digit",hour12:!0})}catch{return e}},we=(e,i)=>e.getFullYear()===i.getFullYear()&&e.getMonth()===i.getMonth()&&e.getDate()===i.getDate(),oe=()=>{const e=new Date,i=e.getHours().toString().padStart(2,"0"),l=e.getMinutes().toString().padStart(2,"0");return`${i}:${l}`},$n=(e,i)=>{const[l,w]=i.split(":").map(Number),f=new Date(e);return f.setHours(l,w,0,0),f},ut=({value:e,onChange:i,includeTime:l=!1,includeYearSelection:w=!1,disabled:f=!1,error:k=!1,popoverTitle:H,minDate:h,maxDate:$,customStyles:pt={}})=>{const[p,B]=c.useState(!1),[D,T]=c.useState(new Date),[U,M]=c.useState(oe()),[se,x]=c.useState(new Date),[gt,mt]=c.useState(""),[ht,V]=c.useState(!1),S=c.useRef(null),ee=c.useRef(null),[o,bt]=c.useState(window.innerWidth<768),[le,de]=c.useState({top:0,left:0});c.useEffect(()=>{const t=()=>{bt(window.innerWidth<768)};return window.addEventListener("resize",t),()=>window.removeEventListener("resize",t)},[]),c.useEffect(()=>{if(e)if(typeof e=="number"){const t=new Date(e);if(T(t),x(t),l){const a=t.getHours().toString().padStart(2,"0"),r=t.getMinutes().toString().padStart(2,"0");M(`${a}:${r}`)}}else if(typeof e=="string"){const t=new Date(e);if(!isNaN(t.getTime())&&(T(t),x(t),l)){const a=t.getHours().toString().padStart(2,"0"),r=t.getMinutes().toString().padStart(2,"0");M(`${a}:${r}`)}}else if(e instanceof Date){if(T(e),x(e),l){const t=e.getHours().toString().padStart(2,"0"),a=e.getMinutes().toString().padStart(2,"0");M(`${t}:${a}`)}}else typeof e=="object"&&e!==null&&"epoch"in e&&(T(new Date(e.date)),x(new Date(e.date)),l&&e.time?M(e.time):l&&M(oe()));else{const t=new Date;T(t),x(t),l&&M(oe())}},[e,l]),c.useEffect(()=>{let t=fe(D);l&&(t+=` (${xe(U)})`),mt(t)},[D,U,l]),c.useEffect(()=>{const t=a=>{p&&ee.current&&!ee.current.contains(a.target)&&S.current&&!S.current.contains(a.target)&&B(!1)};return document.addEventListener("mousedown",t),()=>document.removeEventListener("mousedown",t)},[p]);const ft=t=>h?t<new Date(h.getFullYear(),h.getMonth(),h.getDate()):!1,xt=t=>$?t>new Date($.getFullYear(),$.getMonth(),$.getDate()):!1,ce=t=>ft(t)||xt(t),wt=t=>{ce(t)||T(t)},$t=()=>{x(t=>{const a=new Date(t);return a.setMonth(a.getMonth()-1),h&&a<new Date(h.getFullYear(),h.getMonth(),1)?t:a})},yt=()=>{x(t=>{const a=new Date(t);return a.setMonth(a.getMonth()+1),$&&a>new Date($.getFullYear(),$.getMonth(),1)?t:a})},Z=()=>{const t=new Date,a=t.getFullYear()-100,r=t.getFullYear()+10,d=h?h.getFullYear():a,u=$?$.getFullYear():r;return{minYear:d,maxYear:u}},vt=t=>{x(a=>{const r=new Date(a);return r.setFullYear(t),r}),V(!1)},K=12,te=()=>{const{minYear:t,maxYear:a}=Z(),r=se.getFullYear(),d=Math.floor((r-t)/K)*K+t,u=Math.min(d+K-1,a);return{start:d,end:Math.max(u,d)}},Dt=()=>{const{start:t}=te(),a=Math.max(Z().minYear,t-K);x(r=>{const d=new Date(r);return d.setFullYear(a),d})},Mt=()=>{const{end:t}=te(),a=Math.min(Z().maxYear,t+K);x(r=>{const d=new Date(r);return d.setFullYear(a),d})},St=(t,a)=>{let r;if(l&&a)r=$n(t,a).getTime();else{const d=new Date(t);d.setHours(12,0,0,0),r=d.getTime()}return{epoch:r,date:t.toISOString(),time:l?a:null}},Ct=()=>{const t=St(D,l?U:null);i(t),B(!1)},kt=t=>{const a=t.getFullYear(),r=t.getMonth(),u=new Date(a,r,1).getDay(),ne=new Date(a,r+1,0).getDate(),G=[];if(u>0){const ge=new Date(a,r,0).getDate();for(let ae=ge-u+1;ae<=ge;ae++)G.push(new Date(a,r-1,ae))}const b=[];for(let v=1;v<=ne;v++)b.push(new Date(a,r,v));const Pt=42-G.length-b.length,pe=[];for(let v=1;v<=Pt;v++)pe.push(new Date(a,r+1,v));return[...G,...b,...pe]},Tt=(t,a=!0)=>{const r=we(t,D),d=ce(t),y=we(t,new Date);return n.jsx(pn,{$isCurrentMonth:a,$isSelected:r,$isToday:y,$isMobile:o,$isDisabled:d,onClick:()=>wt(t),children:t.getDate()},t.toISOString())},Vt=()=>{const{start:t,end:a}=te(),{minYear:r,maxYear:d}=Z(),u=Array.from({length:a-t+1},(b,ue)=>t+ue),ne=new Date().getFullYear(),G=D.getFullYear();return n.jsxs(n.Fragment,{children:[n.jsxs(he,{$isMobile:o,children:[n.jsx(Q,{$isMobile:o,onClick:Dt,disabled:t<=r,children:n.jsx(J,{useReactIcon:!0,reactIconName:"MdChevronLeft",reactIconSet:"md",className:"range-selector-icon",size:"small"})}),n.jsxs(an,{type:"button",onClick:()=>V(!1),children:[t," – ",a]}),n.jsx(Q,{$isMobile:o,onClick:Mt,disabled:a>=d,children:n.jsx(J,{useReactIcon:!0,reactIconName:"MdChevronRight",reactIconSet:"md",className:"range-selector-icon",size:"small"})})]}),n.jsx(sn,{$isMobile:o,children:u.map(b=>n.jsx(ln,{$isSelected:b===G,$isCurrentYear:b===ne,$isMobile:o,$isDisabled:b<r||b>d,onClick:()=>vt(b),children:b},b))})]})},Yt=t=>{const a=t.toLocaleString("default",{month:"long"}),r=t.getFullYear(),d=kt(t),u=[m.DAYS_OF_WEEK.SUNDAY,m.DAYS_OF_WEEK.MONDAY,m.DAYS_OF_WEEK.TUESDAY,m.DAYS_OF_WEEK.WEDNESDAY,m.DAYS_OF_WEEK.THURSDAY,m.DAYS_OF_WEEK.FRIDAY,m.DAYS_OF_WEEK.SATURDAY];return n.jsxs(n.Fragment,{children:[n.jsxs(he,{$isMobile:o,children:[n.jsx(Q,{$isMobile:o,onClick:$t,children:n.jsx(J,{useReactIcon:!0,reactIconName:"MdChevronLeft",reactIconSet:"md",className:"range-selector-icon",size:"small"})}),n.jsxs(nn,{$isMobile:o,children:[n.jsx(on,{children:w?a:`${a} ${r}`}),w&&n.jsx(rn,{$isMobile:o,onClick:()=>V(!0),type:"button","aria-label":m.YEAR,children:r})]}),n.jsx(Q,{$isMobile:o,onClick:yt,children:n.jsx(J,{useReactIcon:!0,reactIconName:"MdChevronRight",reactIconSet:"md",className:"range-selector-icon",size:"small"})})]}),n.jsx(dn,{$isMobile:o,children:u.map(y=>n.jsx(cn,{$isMobile:o,children:y},y))}),n.jsx(un,{$isMobile:o,children:d.map(y=>Tt(y,y.getMonth()===t.getMonth()))})]})},jt=()=>{if(!f){if(!p&&!o&&S.current){const t=S.current.getBoundingClientRect(),a=400,r=8,d=window.innerHeight-t.bottom,u=d<a&&t.top>d;de({top:u?t.top-a-r:t.bottom+r,left:Math.max(8,Math.min(t.left,window.innerWidth-356))})}B(!p),p||(x(D),V(!1))}};c.useEffect(()=>(o&&p?document.body.style.overflow="hidden":document.body.style.overflow="",()=>{document.body.style.overflow=""}),[o,p]),c.useLayoutEffect(()=>{if(!o&&p&&S.current){const t=S.current.getBoundingClientRect(),a=400,r=8,d=window.innerHeight-t.bottom,u=d<a&&t.top>d;de({top:u?t.top-a-r:t.bottom+r,left:Math.max(8,Math.min(t.left,window.innerWidth-356))})}},[o,p]);const Wt=H||(l?m.SELECT_DATE_TIME:m.SELECT_DATE),Et=n.jsxs(n.Fragment,{children:[n.jsxs(Kt,{$isMobile:o,children:[n.jsx(Gt,{$isMobile:o,children:Wt}),n.jsx(Jt,{$isMobile:o,onClick:()=>{B(!1),V(!1)},children:n.jsx(It,{style:{width:"10px",height:"10px"},strokeColor:"#6b7280"})})]}),n.jsxs("div",{children:[n.jsxs(Xt,{children:[n.jsx(gn,{$isMobile:o,children:n.jsxs(mn,{$isMobile:o,children:[fe(D),l&&` (${xe(U)})`]})}),n.jsxs(Zt,{$includeTime:l,$isMobile:o,children:[n.jsx(Qt,{$isMobile:o,$includeTime:l,children:n.jsx(en,{children:w&&ht?Vt():Yt(se)})}),l&&n.jsx(tn,{$isMobile:o,children:n.jsxs(hn,{$isMobile:o,children:[n.jsx(bn,{children:m.TIME}),n.jsx(fn,{type:"time",$isMobile:o,value:U,onChange:t=>M(t.target.value),onClick:t=>{const a=t.currentTarget;typeof a.showPicker=="function"&&a.showPicker()}})]})})]})]}),n.jsxs(xn,{$isMobile:o,children:[n.jsx(be,{$variant:"cancel",$isMobile:o,onClick:()=>{B(!1),V(!1)},children:m.CANCEL}),n.jsx(be,{$variant:"apply",$isMobile:o,onClick:Ct,children:m.APPLY})]})]})]});return n.jsxs(Nt,{children:[n.jsxs(re,{$isMobile:o,$isOpen:p,$hasError:k,$isDisabled:f,$customStyles:pt,onClick:f?void 0:jt,ref:S,children:[n.jsx(_t,{$isMobile:o,children:n.jsx(Ot,{width:"20px"})}),n.jsx(Lt,{$isMobile:o,children:gt}),n.jsx(Ht,{$isOpen:p,children:n.jsx(J,{useReactIcon:!0,reactIconName:"MdExpandMore",reactIconSet:"md",className:"range-selector-icon",size:"medium"})})]}),o&&p&&me.createPortal(n.jsx(wn,{}),document.body),p&&me.createPortal(n.jsx(Bt,{$isMobile:o,$isOpen:p,$top:o?void 0:le.top,$left:o?void 0:le.left,ref:ee,children:n.jsx(Ut,{$isMobile:o,$includeTime:l,children:Et})}),document.body)]})},ie=ut;ut.__docgenInfo={description:"",methods:[],displayName:"DateTimePicker",props:{value:{required:!1,tsType:{name:"union",raw:`Date | number | string | {
  epoch: number;
  date: string;
  time: string | null;
...
}`,...(ve=(ye=Y.parameters)==null?void 0:ye.docs)==null?void 0:ve.source}}};var De,Me,Se;j.parameters={...j.parameters,docs:{...(De=j.parameters)==null?void 0:De.docs,source:{originalSource:`args => {
  const [value, setValue] = useState<ValueType>(args.value ?? new Date());
...
}`,...(Se=(Me=j.parameters)==null?void 0:Me.docs)==null?void 0:Se.source}}};var Ce,ke,Te;W.parameters={...W.parameters,docs:{...(Ce=W.parameters)==null?void 0:Ce.docs,source:{originalSource:`args => {
  const [value, setValue] = useState<ValueType>(args.value ?? new Date());
  const handleChange = (newValue: {
    epoch: number;
    date: string;
...
}`,...(Te=(ke=W.parameters)==null?void 0:ke.docs)==null?void 0:Te.source}}};var Ve,Ye,je;E.parameters={...E.parameters,docs:{...(Ve=E.parameters)==null?void 0:Ve.docs,source:{originalSource:`args => {
  const [value, setValue] = useState<ValueType>(args.value ?? new Date());
  const handleChange = (newValue: {
    epoch: number;
    date: string;
...
}`,...(Pe=(Ee=P.parameters)==null?void 0:Ee.docs)==null?void 0:Pe.source}}};var Oe,Ie,Ae;O.parameters={...O.parameters,docs:{...(Oe=O.parameters)==null?void 0:Oe.docs,source:{originalSource:`args => {
  const [value, setValue] = useState<ValueType>(args.value ?? new Date());
  const handleChange = (newValue: {
    epoch: number;
    date: string;
...
}`,...(Ae=(Ie=O.parameters)==null?void 0:Ie.docs)==null?void 0:Ae.source}}};var Re,ze,qe;I.parameters={...I.parameters,docs:{...(Re=I.parameters)==null?void 0:Re.docs,source:{originalSource:`args => {
  const [value, setValue] = useState<ValueType>(args.value ?? new Date());
  const handleChange = (newValue: {
    epoch: number;
    date: string;
...
}`,...(qe=(ze=I.parameters)==null?void 0:ze.docs)==null?void 0:qe.source}}};var Fe,Ne,_e;A.parameters={...A.parameters,docs:{...(Fe=A.parameters)==null?void 0:Fe.docs,source:{originalSource:`args => {
  const [value, setValue] = useState<ValueType>(args.value ?? new Date());
  const handleChange = (newValue: {
    epoch: number;
    date: string;
...
}`,...(_e=(Ne=A.parameters)==null?void 0:Ne.docs)==null?void 0:_e.source}}};var Le,He,Be;R.parameters={...R.parameters,docs:{...(Le=R.parameters)==null?void 0:Le.docs,source:{originalSource:`args => {
  const [value, setValue] = useState<ValueType>(args.value ?? new Date());
  const handleChange = (newValue: {
    epoch: number;
    date: string;
...
}`,...(Be=(He=R.parameters)==null?void 0:He.docs)==null?void 0:Be.source}}};var Ue,Ke,Ge;z.parameters={...z.parameters,docs:{...(Ue=z.parameters)==null?void 0:Ue.docs,source:{originalSource:`args => {
  const [value, setValue] = useState<ValueType>(args.value ?? new Date());
  const handleChange = (newValue: {
    epoch: number;
    date: string;
...
}`,...(Ge=(Ke=z.parameters)==null?void 0:Ke.docs)==null?void 0:Ge.source}}};var Je,Xe,Ze;q.parameters={...q.parameters,docs:{...(Je=q.parameters)==null?void 0:Je.docs,source:{originalSource:`args => {
  const [value, setValue] = useState<ValueType>(args.value ?? new Date());
  const handleChange = (newValue: {
    epoch: number;
    date: string;
...
}`,...(tt=(et=F.parameters)==null?void 0:et.docs)==null?void 0:tt.source}}};var nt,at,ot;N.parameters={...N.parameters,docs:{...(nt=N.parameters)==null?void 0:nt.docs,source:{originalSource:`args => {
  const [value, setValue] = useState<ValueType>(args.value ?? new Date());
  const handleChange = (newValue: {
    epoch: number;
    date: string;
...
}`,...(ot=(at=N.parameters)==null?void 0:at.docs)==null?void 0:ot.source}}};var rt,it,st;_.parameters={..._.parameters,docs:{...(rt=_.parameters)==null?void 0:rt.docs,source:{originalSource:`args => {
  const [value, setValue] = useState<ValueType>(args.value ?? new Date());
  const handleChange = (newValue: {
    epoch: number;
    date: string;
...
}`,...(ct=(dt=L.parameters)==null?void 0:dt.docs)==null?void 0:ct.source}}};const Kn=["Default","Playground","WithTimeSelection","WithYearSelection","Disabled","Error","WithCustomTitle","WithMinDate","WithMaxDate","WithMinAndMaxDate","WithEpochValue","WithObjectValue","MobileDateOnly","MobileWithTime","WithCustomStyles"];export{Y as Default,P as Disabled,O as Error,N as MobileDateOnly,_ as MobileWithTime,j as Playground,L as WithCustomStyles,I as WithCustomTitle,q as WithEpochValue,R as WithMaxDate,z as WithMinAndMaxDate,A as WithMinDate,F as WithObjectValue,W as WithTimeSelection,E as WithYearSelection,Kn as __namedExportsOrder,Un as default};
