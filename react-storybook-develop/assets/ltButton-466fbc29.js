import{j as t}from"./jsx-runtime-8ae9c9ad.js";import{B as k}from"./Button-8d24c33b.js";import{g as u,f as z}from"./styled-components.browser.esm-b57a6336.js";import{M as O}from"./index-019b0ce5.js";import{L as W}from"./index-9e8f50bb.js";const h=e=>(e==null?void 0:e.radius)||"24px",A=(e,r)=>{if(!e)return"border: none;";if(r){const{width:n="1px",type:a="solid",color:o="rgb(209, 213, 219)"}=r;return`border: ${n} ${a} ${o};`}return"border: 1px solid rgb(209, 213, 219);"},I={mini:"32px",tiny:"36px",small:"40px",medium:"44px",large:"48px",big:"52px",huge:"56px",massive:"60px"},j={mini:"mini",tiny:"tiny",small:"small",medium:"small",large:"medium",big:"medium",huge:"large",massive:"large"},b=(e="small")=>I[e]||I.small,Y=(e="small")=>j[e]||j.small,K=e=>{if(!e)return;const r=e.trim().split(/\s+/);return r.length===1?`${r[0]} 0`:r.length===2?`${r[0]} 0`:r.length===3?`${r[0]} 0 ${r[2]}`:`${r[0]} 0 ${r[2]} 0`},N=()=>z`
